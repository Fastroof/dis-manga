--
-- Name: add_book_file_requests; Type: TABLE;
--

CREATE TABLE if not exists add_book_file_requests
(
    id           bigint NOT NULL,
...
alter table add_book_file_requests
...
--
-- Name: edit_book_file_requests; Type: TABLE;
--

CREATE TABLE if NOT EXISTS edit_book_file_requests
(
    id           bigint NOT NULL,
    user_id      bigint NOT NULL,
    status       bigint NOT NULL,
...
alter table edit_book_file_requests
    alter column id add generated by default as identity;
...
ALTER TABLE ONLY add_book_file_requests
    ADD CONSTRAINT add_book_file_requests_pk PRIMARY KEY (id);
...
ALTER TABLE ONLY edit_book_file_requests
    ADD CONSTRAINT edit_book_file_requests_pk PRIMARY KEY (id);
...
ALTER TABLE ONLY add_book_file_requests
    ADD CONSTRAINT add_book_file_requests_books_id_fk FOREIGN KEY (book_id) REFERENCES books (id);

ALTER TABLE ONLY add_book_file_requests
    ADD CONSTRAINT add_book_file_requests_request_statuses_id_fk FOREIGN KEY (status) REFERENCES request_statuses (id);

ALTER TABLE ONLY add_book_file_requests
    ADD CONSTRAINT add_book_file_requests_users_id_fk FOREIGN KEY (user_id) REFERENCES users (id);

ALTER TABLE ONLY add_book_file_requests
    ADD CONSTRAINT add_book_file_requests_users_id_fk_2 FOREIGN KEY (moderator_id) REFERENCES users (id);
...
ALTER TABLE ONLY edit_book_file_requests
    ADD CONSTRAINT edit_book_file_requests_book_files_id_fk FOREIGN KEY (book_file_id) REFERENCES book_files (id);

ALTER TABLE ONLY edit_book_file_requests
    ADD CONSTRAINT edit_book_file_requests_request_statuses_id_fk FOREIGN KEY (status) REFERENCES request_statuses (id);

ALTER TABLE ONLY edit_book_file_requests
    ADD CONSTRAINT edit_book_file_requests_users_id_fk FOREIGN KEY (user_id) REFERENCES users (id);

ALTER TABLE ONLY edit_book_file_requests
    ADD CONSTRAINT edit_book_file_requests_users_id_fk_2 FOREIGN KEY (moderator_id) REFERENCES users (id);
